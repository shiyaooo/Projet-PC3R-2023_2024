...
<body>
	...
	<main class="main">
        <h1> Movie&Critics > Films > More Popular Movies</h1>
        <div class="movies-container" id="morePopularMovies">      
        </div>  
       </main>
    <script>
    function retour() {
    ...
    function displayMovies(movies, containerId) {
        ...
        if (movies && movies.length > 0) {
            movies.forEach(movie => {
                ...
                /*<div class="movie">
              	<img src="https://image.tmdb.org/t/p/w500/xf1rEQRi9pZxoN8HfggVnhjOaBb.jpg" alt="Godzilla x Kong: The New Empire">
    ...
    window.onload = async function() {
        ...
        displayMovies(allMovies, 'morePopularMovies');
    };
